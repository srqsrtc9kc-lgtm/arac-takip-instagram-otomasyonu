...
export default async function PublishedPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      <h1 className="text-xl font-semibold">Paylaşılanlar</h1>
      ...
      {error ? (
        ...
        <div className="mt-6 rounded-xl border border-neutral-800 bg-neutral-900/50 p-8 text-center">
          ...
          <p className="mt-2 text-sm text-neutral-500">
            İlk paylaşım, Meta Graph API entegrasyonu (Adım 8) tamamlanıp bir içerik
            onaylandıktan sonra buraya düşecek.
          </p>
        </div>
      ) : (
